        ...
        <div id="login-body" class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 well">
            ...
            <form role="form" action='front/login.php' method='post'>
              ...
              <div class="form-group">
                  <input class="form-control input-lg" name="<?php echo $namfield; ?>" id="login_name" placeholder="<?php echo __('User') ?>" type="text">
              </div>
              <div class="form-group">
                  <input class="form-control input-lg" name="<?php echo $pwdfield; ?>" id="login_password" placeholder="<?php echo __('Password') ?>" type="password">
              </div>
